...
from .views import AccountCreationView,SignInView,EmployerCreateView,JobCreateView,ListPostedJobView,EditJobView,JobDeleteView,SignOutView,ApplicantListView,EmployerProfileDispalyView,UpdateApplicationStatusView
...
urlpatterns = [
   path("register",AccountCreationView.as_view(),name="register"),
    ...
    path("status/<int:pk>",UpdateApplicationStatusView.as_view(),name="updatestatus")
